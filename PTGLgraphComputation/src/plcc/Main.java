...
//            dsspFile = pdbid + ".dssp";  // md: dsspFile (now sseFile) isn't mandatory anymore. Furthermore the default file extension of a DSSP 4 file is .cif
                ...
                for (Integer i = 1; i < args.length; i++) {
                    ...
                    if(s.equals("--graphlet-sim-method")) {
                        if(args.length <= i+1 ) {
                            ...
                            if(gm.equals(SimilarityByGraphlets.GRAPHLET_SIM_METHOD_RGF)) {
                                Settings.set("PTGLgraphComputation_S_search_similar_graphlet_scoretype", SimilarityByGraphlets.GRAPHLET_SIM_METHOD_RGF);
                            }
                            else if(gm.equals(SimilarityByGraphlets.GRAPHLET_SIM_METHOD_CUSTOM)) {
                                Settings.set("PTGLgraphComputation_S_search_similar_graphlet_scoretype", SimilarityByGraphlets.GRAPHLET_SIM_METHOD_CUSTOM);
                            }
                            else {
                    ...
                    if(s.equals("-Y") || s.equals("--skip-vast")) {
                        if(args.length <= i+1 ) {
                            ...
                            Settings.set("PTGLgraphComputation_B_skip_too_large", "true");
                            Settings.set("PTGLgraphComputation_I_skip_num_atoms_threshold", args[i+1]);
                            argsUsed[i] = true;
                            argsUsed[i+1] = true;
                        }
                    }
                    ...
                    if(s.equals("--report-db-proteins")) {
                        ...
                        Settings.set("PTGLgraphComputation_B_report_db_proteins", "true");
                        argsUsed[i] = true;
                    }
                    ...
                    if(s.equals("--convert-models-to-chains")) {
                        ...
                        if(args.length <= i+1 ) {
                            ...
                            useFileFromCommandline = false;
                            Settings.set("PTGLgraphComputation_B_convert_models_to_chains", "true");                        
                    ...
                    if(s.equals("--alt-aa-contacts")) {
                        ...
                        Settings.set("PTGLgraphComputation_B_alternate_aminoacid_contact_model", "true");
                        Settings.set("PTGLgraphComputation_B_handle_hydrogen_atoms_from_reduce", "true");
                        //adjust other settings here
                        Settings.set("PTGLgraphComputation_B_AAgraph_allchainscombined", "true");
                        Settings.set("PTGLgraphComputation_B_aminoacidgraphs_include_ligands", "true");
                        Settings.set("PTGLgraphComputation_B_quit_after_aag", "true");
                    ...
                    if(s.equals("--alt-aa-contacts-ligands")) {
                        useFileFromCommandline = true;
                        Settings.set("PTGLgraphComputation_B_alternate_aminoacid_contact_model_with_ligands", "true");
                        Settings.set("PTGLgraphComputation_B_handle_hydrogen_atoms_from_reduce", "true");
                        //adjust other settings here
                        Settings.set("PTGLgraphComputation_B_AAgraph_allchainscombined", "true");
                        Settings.set("PTGLgraphComputation_B_aminoacidgraphs_include_ligands", "true");
                    ...
                    if(s.equals("-N") || s.equals("--no-warn")) {
                        Settings.set("PTGLgraphComputation_B_no_warn", "true");
                        argsUsed[i] = true;
                    }
                    
                    if(s.equals("--cluster")) {                        
                        Settings.set("PTGLgraphComputation_B_clustermode", "true");
                        Settings.set("PTGLgraphComputation_B_silent", "true");
                        //Settings.set("PTGLgraphComputation_B_write_chains_file", "true");
                        Settings.set("PTGLgraphComputation_B_compute_motifs", "true");
                        Settings.set("PTGLgraphComputation_B_complex_graphs", "true");
                        Settings.set("PTGLgraphComputation_B_separate_contacts_by_chain", "false");
                        Settings.set("PTGLgraphComputation_B_folding_graphs", "true");
                        Settings.set("PTGLgraphComputation_B_draw_folding_graphs", "true");
                        Settings.set("PTGLgraphComputation_B_output_images_dir_tree", "true");
                        Settings.set("PTGLgraphComputation_B_output_textfiles_dir_tree", "true");
                        Settings.set("PTGLgraphComputation_B_useDB", "true");
                        //Settings.set("PTGLgraphComputation_B_AAgraph_allchainscombined", "true");
                        //Settings.set("PTGLgraphComputation_B_AAgraph_perchain", "true");
                        Settings.set("PTGLgraphComputation_B_no_warn", "true");
                        argsUsed[i] = true;
                    ...
                    if(s.equals("--less-output")) {
                        Settings.set("PTGLgraphComputation_B_only_essential_output", "true");
                        argsUsed[i] = true;
                    }
                    
                    if(s.equals("--verbose")) {
                        Settings.set("PTGLgraphComputation_B_only_essential_output", "false");
                        argsUsed[i] = true;
                    }
                    ...
                    if(s.equals("--no-motifs")) {
                        Settings.set("PTGLgraphComputation_B_compute_motifs", "false");
                        argsUsed[i] = true;
                    }
                    
                    if(s.equals("--db-batch")) {
                        Settings.set("PTGLgraphComputation_B_db_use_batch_inserts", "true");
                        argsUsed[i] = true;
                    }
                    if(s.equals("--no-db-batch")) {
                        Settings.set("PTGLgraphComputation_B_db_use_batch_inserts", "false");
                        argsUsed[i] = true;
                        argsUsed[i] = true;
                    }
                    ...
                    if(s.equals("--compute-whole-db-graphlet-similarities")) {
                        useFileFromCommandline = false;
                        Settings.set("PTGLgraphComputation_B_useDB", "true");
                        Settings.set("PTGLgraphComputation_B_compute_graphlet_similarities", "true");
                        Settings.set("PTGLgraphComputation_B_compute_graphlet_similarities_pg", "true");
                        Settings.set("PTGLgraphComputation_B_compute_graphlet_similarities_cg", "true");
                        Settings.set("PTGLgraphComputation_B_compute_graphlet_similarities_aag", "true");
                        argsUsed[i] = true;
                    }
                    ...
                    if(s.equals("--compute-graph-metrics")) {
                        Settings.set("PTGLgraphComputation_B_compute_graph_metrics", "true");
                        argsUsed[i] = true;
                    }
                    ...
                    if(s.equals("--set-pdb-representative-chains-pre")) {
                        ...
                        if(args.length <= i+2 ) {
                            ...
                            useFileFromCommandline = false;                                                        
                            Settings.set("PTGLgraphComputation_B_useDB", "true");
                            Settings.set("PTGLgraphComputation_B_set_pdb_representative_chains_pre", "true");
                            Settings.set("PTGLgraphComputation_S_representative_chains_xml_file", args[i+1]);
                            if(args[i+2].equals("keep")) {
                                Settings.set("PTGLgraphComputation_B_set_pdb_representative_chains_remove_old_labels_pre", "false");
                            }
                            else if(args[i+2].equals("remove")) {
                                Settings.set("PTGLgraphComputation_B_set_pdb_representative_chains_remove_old_labels_pre", "true");
                            }
                            else {
                                syntaxError("The --set-pdb-representative-chains-pre option requires an XML file to read the data from AND the info whether to remove old labels. For the latter, valid values are 'keep' or 'remove'.");
                            }
                    ...
                    if(s.equals("--set-pdb-representative-chains-post")) {
                        ...
                        if(args.length <= i+2 ) {
                            ...
                            useFileFromCommandline = false;                                                        
                            Settings.set("PTGLgraphComputation_B_useDB", "true");
                            Settings.set("PTGLgraphComputation_B_set_pdb_representative_chains_post", "true");
                            Settings.set("PTGLgraphComputation_S_representative_chains_xml_file", args[i+1]);
                            if(args[i+2].equals("keep")) {
                                Settings.set("PTGLgraphComputation_B_set_pdb_representative_chains_remove_old_labels_post", "false");
                            }
                            else if(args[i+2].equals("remove")) {
                                Settings.set("PTGLgraphComputation_B_set_pdb_representative_chains_remove_old_labels_post", "true");
                            }
                            else {
                                syntaxError("The --set-pdb-representative-chains-post option requires an XML file to read the data from AND the info whether to remove old labels. For the latter, valid values are 'keep' or 'remove'.");
                            }
                    ...
                    if(s.equals("-L") || s.equals("--lig-filter")) {
                        if(args.length <= i+2 ) {
                            ...
                            if(min > max && max != 0) {
                                ...
                                Settings.set("PTGLgraphComputation_I_lig_min_atoms", min.toString());
                                Settings.set("PTGLgraphComputation_I_lig_max_atoms", max.toString());
                            }
                            argsUsed[i] = true;
                            argsUsed[i+1] = true;
                            argsUsed[i+2] = true;
                    ...
                    if(s.equals("-S") || s.equals("--sim-measure")) {
                        ...
                        if(args.length <= i+1 ) {
                            ...
                            Settings.set("PTGLgraphComputation_S_search_similar_method", args[i+1]);
                            argsUsed[i] = true;
                            argsUsed[i+1] = true;                            
                        }
                    }
                    ...
                    if(s.equals("-M") || s.equals("--similar")) {
                        ...
                        if(args.length <= i+3 ) {
                            ...
                            Settings.set("PTGLgraphComputation_B_search_similar", "true");
                            Settings.set("PTGLgraphComputation_B_search_similar_PDBID", args[i+1]);
                            Settings.set("PTGLgraphComputation_B_search_similar_chainID", args[i+2]);
                            Settings.set("PTGLgraphComputation_S_search_similar_graphtype", args[i+3]);                            
                        }
                        argsUsed[i] = true;
                        argsUsed[i+1] = true;
                        argsUsed[i+2] = true;
                    ...
                    if(s.equals("-v") || s.equals("--del-db-protein")) {
                        if(args.length <= i+1 ) {
                            ...
                            if(DBManager.init(Settings.get("PTGLgraphComputation_S_db_name"), Settings.get("PTGLgraphComputation_S_db_host"), Settings.getInteger("PTGLgraphComputation_I_db_port"), Settings.get("PTGLgraphComputation_S_db_username"), Settings.get("PTGLgraphComputation_S_db_password"), Settings.getBoolean("PTGLgraphComputation_B_db_use_autocommit"))) {
                                try {
                    ...
                    if(s.equals("-j") || s.equals("--ddb")) {
                        if(args.length <= i+4 ) {
                            ...
                            if(DBManager.init(Settings.get("PTGLgraphComputation_S_db_name"), Settings.get("PTGLgraphComputation_S_db_host"), Settings.getInteger("PTGLgraphComputation_I_db_port"), Settings.get("PTGLgraphComputation_S_db_username"), Settings.get("PTGLgraphComputation_S_db_password"), Settings.getBoolean("PTGLgraphComputation_B_db_use_autocommit"))) {
                                drawPlccGraphFromDB(a_pdbid, a_chain, a_gt, a_outFile + Settings.get("PTGLgraphComputation_S_img_output_fileext"), false);
                    ...
                    if(s.equals("-X") || s.equals("--check-ssects")) {
                        if(args.length <= i+1 ) {
                            ...
                            Settings.set("PTGLgraphComputation_B_debug_compareSSEContacts", "true");
                            Settings.set("PTGLgraphComputation_S_debug_compareSSEContactsFile", args[i+1]);
                            argsUsed[i] = true;
                            argsUsed[i+1] = true;
                        }
                    }                                        
                    ...
                    if(s.equals("-y") || s.equals("--write-geodat")) {
                        Settings.set("PTGLgraphComputation_B_ptgl_geodat_output", "true");
                        argsUsed[i] = true;
                    }
                    
                    if(s.equals("--force")) {
                        Settings.set("PTGLgraphComputation_F_abort_if_pdb_resolution_worse_than", "-1.0");
                        Settings.set("PTGLgraphComputation_I_abort_if_num_molecules_below", "-1");
                        argsUsed[i] = true;
                    }
                    
                    if(s.equals("-E") || s.equals("--separate-contacts")) {
                        Settings.set("PTGLgraphComputation_B_separate_contacts_by_chain", "true");
                        argsUsed[i] = true;
                    }
                    ...
                    if(s.equals("-z") || s.equals("--ramaplot")) {
                        Settings.set("PTGLgraphComputation_B_ramachandran_plot", "true");
                        argsUsed[i] = true;
                    }
                    ...
                    if(s.equals("-r") || s.equals("--recreate-tables") || s.equals("--recreate-tables-empty")) {
                        ...
                        if(DBManager.init(Settings.get("PTGLgraphComputation_S_db_name"), Settings.get("PTGLgraphComputation_S_db_host"), Settings.getInteger("PTGLgraphComputation_I_db_port"), Settings.get("PTGLgraphComputation_S_db_username"), Settings.get("PTGLgraphComputation_S_db_password"), true)) {
                    ...
                    if(s.equals("-a") || s.equals("--include-coils")) {
                        Settings.set("PTGLgraphComputation_B_include_coils", "true");
                        argsUsed[i] = true;
                    }
                                    
                    if(s.equals("-B") || s.equals("--force-backbone")) {
                        Settings.set("PTGLgraphComputation_B_forceBackboneContacts", "true");
                        argsUsed[i] = true;
                    }
                   

                    if(s.equals("-w") || s.equals("--dont-write-images")) {
                        Settings.set("PTGLgraphComputation_B_draw_graphs", "false");
                        argsUsed[i] = true;
                    }

                    if(s.equals("-c") || s.equals("--dont-calc-graphs")) {
                        Settings.set("PTGLgraphComputation_B_calc_draw_graphs", "false");
                        argsUsed[i] = true;
                    }
                    
                    if(s.equals("--no-ptgl")) {
                        Settings.set("PTGLgraphComputation_B_round_coordinates", "true");
                        argsUsed[i] = true;
                    }
                    ...
                    if(s.equals("-W") || s.equals("--output-www")) {
                        Settings.set("PTGLgraphComputation_B_output_images_dir_tree", "true");
                        Settings.set("PTGLgraphComputation_B_output_textfiles_dir_tree", "true");
                        Settings.set("PTGLgraphComputation_B_output_textfiles_dir_tree_html", "true");
                        argsUsed[i] = true;
                    }
                    ...
                    if(s.equals("-H") || s.equals("--output-www-with-core")) {
                        ...
                        Settings.set("PTGLgraphComputation_B_output_textfiles_dir_tree", "true");
                        Settings.set("PTGLgraphComputation_B_output_textfiles_dir_tree_html", "true");
                        Settings.set("PTGLgraphComputation_B_output_textfiles_dir_tree_core_html", "true");
                        argsUsed[i] = true;
                    }
                    
                    
                    if(s.equals("--contact-level-debugging")) {                                                                        
                        Settings.set("PTGLgraphComputation_B_contact_debug_dysfunct", "true");
                        argsUsed[i] = true;
                    }
                    
                    if(s.equals("--draw-aag")) {                                                                        
                        Settings.set("PTGLgraphComputation_B_draw_aag", "true");
                        argsUsed[i] = true;
                    }
                    ...
                    if(s.equals("-n") || s.equals("--textfiles")) {
                        Settings.set("PTGLgraphComputation_B_ptgl_text_output", "true");
                        argsUsed[i] = true;
                    }
                    ...
                    if(s.equals("-q") || s.equals("--fg-notations")) {
                        if(args.length <= i+1 ) {
                            ...
                            Settings.set("PTGLgraphComputation_B_foldgraphtype_KEY", "false");
                            Settings.set("PTGLgraphComputation_B_foldgraphtype_ADJ", "false");
                            Settings.set("PTGLgraphComputation_B_foldgraphtype_RED", "false");
                            Settings.set("PTGLgraphComputation_B_foldgraphtype_SEQ", "false");
                            ...
                            if(types.contains("k")) { Settings.set("PTGLgraphComputation_B_foldgraphtype_KEY", "true"); nv++; }
                            if(types.contains("a")) { Settings.set("PTGLgraphComputation_B_foldgraphtype_ADJ", "true"); nv++; }
                            if(types.contains("r")) { Settings.set("PTGLgraphComputation_B_foldgraphtype_RED", "true"); nv++; }
                            if(types.contains("s")) { Settings.set("PTGLgraphComputation_B_foldgraphtype_SEQ", "true"); nv++; }
                    ...
                    if(s.equals("-g") || s.equals("--sse-graphtypes")) {
                        if(args.length <= i+1 ) {
                            ...
                            Settings.set("PTGLgraphComputation_B_calc_draw_graphs", "true");
                            
                            // If the user specifies the folding graph types manually, all those
                            // which are NOT listed default to 'off':                                                        
                            Settings.set("PTGLgraphComputation_B_graphtype_albe", "false");
                            Settings.set("PTGLgraphComputation_B_graphtype_albelig", "false");
                            Settings.set("PTGLgraphComputation_B_graphtype_alpha", "false");
                            Settings.set("PTGLgraphComputation_B_graphtype_alphalig", "false");
                            Settings.set("PTGLgraphComputation_B_graphtype_beta", "false");
                            Settings.set("PTGLgraphComputation_B_graphtype_betalig", "false");
                            ...
                            if(types.contains("a")) { Settings.set("PTGLgraphComputation_B_graphtype_alpha", "true"); nv++; }
                            if(types.contains("b")) { Settings.set("PTGLgraphComputation_B_graphtype_beta", "true"); nv++; }
                            if(types.contains("c")) { Settings.set("PTGLgraphComputation_B_graphtype_albe", "true"); nv++; }
                            if(types.contains("d")) { Settings.set("PTGLgraphComputation_B_graphtype_alphalig", "true"); nv++; }
                            if(types.contains("e")) { Settings.set("PTGLgraphComputation_B_graphtype_betalig", "true"); nv++; }
                            if(types.contains("f")) { Settings.set("PTGLgraphComputation_B_graphtype_albelig", "true"); nv++; }
                    ...
                    if(s.equals("-O") || s.equals("--outputformats")) {
                        if(args.length <= i+1 ) {
                            ...
                            // which are NOT listed default to 'off':                                                        
                            Settings.set("PTGLgraphComputation_B_output_GML", "false");
                            Settings.set("PTGLgraphComputation_B_output_TGF", "false");
                            Settings.set("PTGLgraphComputation_B_output_DOT", "false");
                            Settings.set("PTGLgraphComputation_B_output_kavosh", "false");
                            Settings.set("PTGLgraphComputation_B_output_eld", "false");
                            Settings.set("PTGLgraphComputation_B_output_plcc", "false");
                            Settings.set("PTGLgraphComputation_B_output_perlfg", "false");
                            Settings.set("PTGLgraphComputation_B_output_json", "false");
                            Settings.set("PTGLgraphComputation_B_output_xml", "false");
                            Settings.set("PTGLgraphComputation_B_output_gexf", "false");
                            Settings.set("PTGLgraphComputation_B_output_cytoscapejs", "false");
                            ...
                            if(types.equals("x")) {
                                ...
                                if(types.contains("g")) { Settings.set("PTGLgraphComputation_B_output_GML", "true"); nv++; }
                                if(types.contains("t")) { Settings.set("PTGLgraphComputation_B_output_TGF", "true"); nv++; }
                                if(types.contains("d")) { Settings.set("PTGLgraphComputation_B_output_DOT", "true"); nv++; }
                                if(types.contains("k")) { Settings.set("PTGLgraphComputation_B_output_kavosh", "true"); nv++; }
                                if(types.contains("e")) { Settings.set("PTGLgraphComputation_B_output_eld", "true"); nv++; }
                                if(types.contains("p")) { Settings.set("PTGLgraphComputation_B_output_plcc", "true"); nv++; }
                                if(types.contains("l")) { Settings.set("PTGLgraphComputation_B_output_perlfg", "true"); nv++; }
                                if(types.contains("j")) { Settings.set("PTGLgraphComputation_B_output_json", "true"); nv++; }
                                if(types.contains("m")) { Settings.set("PTGLgraphComputation_B_output_xml", "true"); nv++; }
                                if(types.contains("f")) { Settings.set("PTGLgraphComputation_B_output_gexf", "true"); nv++; }
                                if(types.contains("c")) { Settings.set("PTGLgraphComputation_B_output_cytoscapejs", "true"); nv++; }
                    ...
                    if(s.equals("--debug") || s.equals("-D")) {
                        if(args.length <= i+1 ) {
                            ...
                            Settings.set("PTGLgraphComputation_I_debug_level", args[i+1]);
                            argsUsed[i] = true;
                            argsUsed[i+1] = true;
                        }
                    }
                    ...
                    if(s.equals("--force-chain") || s.equals("-e")) {
                        if(args.length <= i+1 ) {
                            ...
                            Settings.set("PTGLgraphComputation_B_force_chain", "true");
                            Settings.set("PTGLgraphComputation_S_forced_chain_id", args[i+1]);    
                            argsUsed[i] = true;
                            argsUsed[i+1] = true;
                        }
                    }
                    ...
                    if(s.equals("-t") || s.equals("--draw-tgf-graph")) {
                        if(args.length <= i+1 ) {
                            ...
                            argsUsed[i] = true;
                            argsUsed[i+1] = true;
                            Settings.set("PTGLgraphComputation_B_graphimg_header", "false");
                    ...
                    if(s.equals("-l") || s.equals("--draw-plcc-graph")) {
                        if(args.length <= i+1 ) {
                            ...
                            drawPlccGraphFromFile(args[i+1], args[i+1] + Settings.get("PTGLgraphComputation_S_img_output_fileext"), false);
                    ...
                    if(s.equals("-b") || s.equals("--draw-plcc-fgs")) {
                        if(args.length <= i+1 ) {
                            ...
                            argsUsed[i+1] = true;
                            Settings.set("PTGLgraphComputation_B_folding_graphs", "true");
                            Settings.set("PTGLgraphComputation_B_draw_graphs", "true");                            
                            System.out.println("Drawing protein graph and folding graphs in plcc format from file '" + args[i+1] + "'.");
                            drawPlccGraphFromFile(args[i+1], args[i+1] + Settings.get("PTGLgraphComputation_S_img_output_fileext"), true);
                    ...
                    if(s.equals("--aa-graphs-pdb")) {
                        Settings.set("PTGLgraphComputation_B_AAgraph_allchainscombined", "true");
                        Settings.set("PTGLgraphComputation_B_AAgraph_perchain", "false");
                        argsUsed[i] = true;
                    }
                    
                    if(s.equals("--aa-graphs-chain")) {
                        Settings.set("PTGLgraphComputation_B_AAgraph_allchainscombined", "false");
                        Settings.set("PTGLgraphComputation_B_AAgraph_perchain", "true");
                        argsUsed[i] = true;
                    }
                    
                    if(s.equals("-I") || s.equals("--mmCIF-parser")) {
                        Settings.set("PTGLgraphComputation_B_use_mmCIF_parser", "true");
                        argsUsed[i] = true;
                    }
                    ...
                    if(s.equals("--cg-threshold")) {
                        if(args.length <= i+1 ) {
                            ...
                            argsUsed[i] = true;
                            argsUsed[i+1] = true;
                            Settings.set("PTGLgraphComputation_I_CG_contact_threshold", args[i+1]);
                        }
                    }
                    
                    if(s.equals("--chain-spheres-speedup")) {
                        argsUsed[i] = true;
                        Settings.set("PTGLgraphComputation_B_chain_spheres_speedup", "true");
                    }
                   
                    if(s.equals("--include-rna"))  {
                        argsUsed[i] = true;
                        Settings.set("PTGLgraphComputation_B_include_rna", "true");
                    }
                    ...
                    if(s.equals("--matrix-structure-search")) {
                        ...
                        Settings.set("PTGLgraphComputation_S_linear_notation_type", args[i+1]);                        
                        Settings.set("PTGLgraphComputation_S_linear_notation", args[i+2]);
                        Settings.set("PTGLgraphComputation_S_linear_notation_graph_type", args[i+3]);
                        Settings.set("PTGLgraphComputation_B_matrix_structure_search", "true");
                    ...
                    if (s.equals("--matrix-structure-search-db")){
                        ...
                        Settings.set("PTGLgraphComputation_S_linear_notation", args[i+2]);
                        Settings.set("PTGLgraphComputation_S_linear_notation_graph_type", args[i+3]);
                        Settings.set("PTGLgraphComputation_B_matrix_structure_search_db", "true");
                        argsUsed[i] = argsUsed[i+1] = argsUsed[i+2] = argsUsed[i+3] = true;
                    }
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_silent")) {
            if(Settings.getBoolean("PTGLgraphComputation_B_print_silent_notice")) {
                String startTime = new SimpleDateFormat("HH:mm:ss").format(new Date());
                if(Settings.getBoolean("PTGLgraphComputation_B_no_warn")) {
                    System.out.println(Settings.getApptag() + " [" + pdbid + "] [" + startTime + "] Silent mode and no-warn active, only errors and a final completion notice will be printed from now on. Bye.");
                } else {
                    System.out.println(Settings.getApptag() + " [" + pdbid + "] [" + startTime + "] Silent mode active, only errors, warnings and a final completion notice will be printed from now on. Bye.");
                }
            }
            silent = true;
        } else {
        ...
        if (Settings.getBoolean("PTGLgraphComputation_B_centroid_method")) {
            if (! silent) {
        ...
        if (! Settings.getBoolean("PTGLgraphComputation_B_spatrel_use_dd") && Settings.getInteger("PTGLgraphComputation_I_spatrel_vector_num_res_centroids") < 1) {
            Settings.set("PTGLgraphComputation_I_spatrel_vector_num_res_centroids", "1");
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_search_similar")) {
            if(! silent) {
                System.out.println("Searching for proteins similar to PDB ID '" + Settings.get("PTGLgraphComputation_B_search_similar_PDBID") + "' chain '" + Settings.get("PTGLgraphComputation_B_search_similar_chainID") + "' graph type '" + Settings.get("PTGLgraphComputation_S_search_similar_graphtype") + "'.");
            }
            
            if(DBManager.init(Settings.get("PTGLgraphComputation_S_db_name"), Settings.get("PTGLgraphComputation_S_db_host"), Settings.getInteger("PTGLgraphComputation_I_db_port"), Settings.get("PTGLgraphComputation_S_db_username"), Settings.get("PTGLgraphComputation_S_db_password"), Settings.getBoolean("PTGLgraphComputation_B_db_use_autocommit"))) {
                
                if(Settings.get("PTGLgraphComputation_S_search_similar_method").equals(Similarity.SIMILARITYMETHOD_STRINGSSE)) {
                    if(! silent) {
                        System.out.println("Using similarity method '" + Settings.get("PTGLgraphComputation_S_search_similar_method") + "'.");                        
                    }
                
                    String patternSSEString = null;
                    try {
                        patternSSEString = DBManager.getSSEStringOfProteinGraph(Settings.get("PTGLgraphComputation_B_search_similar_PDBID"), Settings.get("PTGLgraphComputation_B_search_similar_chainID"), Settings.get("PTGLgraphComputation_S_search_similar_graphtype"));
                    } catch (Exception e) {
                ...
                } else if (Settings.get("PTGLgraphComputation_S_search_similar_method").equals(Similarity.SIMILARITYMETHOD_GRAPHSET)) {
                    if(! silent) {
                        System.out.println("Using similarity method '" + Settings.get("PTGLgraphComputation_S_search_similar_method") + "'.");
                    }
                    CompareOneToDB.performGraphSetComparison();                    
                }
                else if (Settings.get("PTGLgraphComputation_S_search_similar_method").equals(Similarity.SIMILARITYMETHOD_GRAPHCOMPAT)) {
                    if(! silent) {
                        System.out.println("Using similarity method '" + Settings.get("PTGLgraphComputation_S_search_similar_method") + "'.");
                    }
                    ...
                    System.err.println("ERROR: Invalid similarity method: '" + Settings.get("PTGLgraphComputation_S_search_similar_method") + "'. Use --help for info on valid settings.");
                    System.exit(1);
                }
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_compute_graphlet_similarities")) {
            ...
            if(! silent) {
                System.out.println("Computing pairwise graphlet similarities. Considering " + numToConsider + " graphlets from the array in database (index " + Settings.getInteger("PTGLgraphComputation_I_compute_all_graphlet_similarities_start_graphlet_index") + " - " + Settings.getInteger("PTGLgraphComputation_I_compute_all_graphlet_similarities_end_graphlet_index") + ").");
            }
            
            if(DBManager.initUsingDefaults()) {
                // protein graphs
                if(Settings.getBoolean("PTGLgraphComputation_B_compute_graphlet_similarities_pg")) {
                    if(! silent) {
                    ...
                    Long[] res = DBManager.computeGraphletSimilarityScoresForPGsWholeDatabaseAndStoreBest(ProtGraph.GRAPHTYPE_ALBE, Settings.getInteger("PTGLgraphComputation_I_compute_all_graphlet_similarities_num_to_save_in_db"));
                ...
                // complex graphs
                if(Settings.getBoolean("PTGLgraphComputation_B_compute_graphlet_similarities_cg")) {
                    if(! silent) {
                    ...
                    Long[] res = DBManager.computeGraphletSimilarityScoresForCGsWholeDatabaseAndStoreBest(Settings.getInteger("PTGLgraphComputation_I_compute_all_graphlet_similarities_num_to_save_in_db"));
                    // numChainsFound, numGraphletsFound, numScoresComputed, numScoresSaved
                    if(! silent) {
                ...
                // amino acid graphs
                if(Settings.getBoolean("PTGLgraphComputation_B_compute_graphlet_similarities_aag")) {
                    if(! silent) {
                    ...
                    Integer numToSave = Settings.getInteger("PTGLgraphComputation_I_compute_all_graphlet_similarities_num_to_save_in_db");
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_set_pdb_representative_chains_pre") || Settings.getBoolean("PTGLgraphComputation_B_set_pdb_representative_chains_post")) {
            
            File xmlFile = new File(Settings.get("PTGLgraphComputation_S_representative_chains_xml_file"));
            
            if(! silent) {
                System.out.println("Marking all representative PDB chains in the database from data in XML file '" + Settings.get("PTGLgraphComputation_S_representative_chains_xml_file") + "'...");
            ...
            if(DBManager.initUsingDefaults()) {
                ...
                if(Settings.getBoolean("PTGLgraphComputation_B_set_pdb_representative_chains_post")) {
                    ...
                    if(Settings.getBoolean("PTGLgraphComputation_B_set_pdb_representative_chains_remove_old_labels_post")) {
                        try {
                ...
                if(Settings.getBoolean("PTGLgraphComputation_B_set_pdb_representative_chains_pre")) {
                    if(numChainsInDB > 0) {
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_report_db_proteins")) {
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_convert_models_to_chains")) {
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_matrix_structure_search_db")) {
            String linnotGraphType = Settings.get("PTGLgraphComputation_S_linear_notation_graph_type");
            ...
            if(DBManager.initUsingDefaults()) {
                System.out.println("Start searching the linear notation " + Settings.get("PTGLgraphComputation_S_linear_notation") + " in the PTGL database.");

                ArrayList<ArrayList<String>> results = new ArrayList<ArrayList<String>>();

                results = DBManager.matrixSearchDB(Settings.get("PTGLgraphComputation_S_linear_notation"), linnotGraphType);
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_useDB")) {
            String plcc_db_name = Settings.get("PTGLgraphComputation_S_db_name");
            String plcc_db_host = Settings.get("PTGLgraphComputation_S_db_host");
            Integer plcc_db_port = Settings.getInteger("PTGLgraphComputation_I_db_port");
            String plcc_db_username = Settings.get("PTGLgraphComputation_S_db_username");
            String plcc_db_password = Settings.get("PTGLgraphComputation_S_db_password");
            if(! silent) {
            ...
            if(! (silent || Settings.getBoolean("PTGLgraphComputation_B_only_essential_output"))) {
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_ptgl_text_output")) {
            if(! silent) {
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_skip_too_large")) {
            if(atoms.size() > Settings.getInteger("PTGLgraphComputation_I_skip_num_atoms_threshold")) {
                System.err.println("===== Terminating: 'plcc_B_skip_too_large' is enabled in settings and this protein has too many atoms =====");
                if(! silent) {
                    System.out.println("Maximal number of atoms allowed in PDB file is set to " + Settings.getInteger("PTGLgraphComputation_I_skip_num_atoms_threshold") + " and PDB " + pdbid + " contains " + atoms.size() + ".");
        ...
        Float badResolution = Settings.getFloat("PTGLgraphComputation_F_abort_if_pdb_resolution_worse_than");
        ...
        Integer minNumberOfResidues = Settings.getInteger("PTGLgraphComputation_I_abort_if_num_molecules_below");
        ...
        //      --> yeah, still seems so
        if (Settings.getBoolean("PTGLgraphComputation_B_chain_spheres_speedup") && chains.size() == 1) {
            Settings.set("PTGLgraphComputation_B_chain_spheres_speedup", "false");
            Settings.set("PTGLgraphComputation_B_centroid_method", "false");  // not optimized for old contact computation
            if (! silent) {
        ...
        */
        ...
        boolean separateContactsByChain = Settings.getBoolean("PTGLgraphComputation_B_separate_contacts_by_chain");
        ...
        if (Settings.getBoolean("PTGLgraphComputation_B_debug_only_contact_comp")) {
            System.out.println("Exiting now as requested by settings.");
            System.exit(0);
        }
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_print_contacts")) {
            if(separateContactsByChain) {
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_write_chains_file")) {
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_force_chain")) {
        
            if(! silent) {
                System.out.println(" Forced handling of the chain with chain ID '" + Settings.get("PTGLgraphComputation_S_forced_chain_id") + "' only.");
            }
            
            for(Chain c : chains) {
                if(c.getPdbChainID().equals(Settings.get("PTGLgraphComputation_S_forced_chain_id"))) {
                    handleChains.add(c);
                }
            }
        ...
        Boolean drawRPlots = Settings.getBoolean("PTGLgraphComputation_B_ramachandran_plot");
        ...
        if(Settings.getInteger("PTGLgraphComputation_I_aag_min_residue_seq_distance_for_contact") > 0 && Settings.getInteger("PTGLgraphComputation_I_aag_max_residue_seq_distance_for_contact") > 0) {
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_calc_draw_graphs")) {
            if(! (silent || Settings.getBoolean("PTGLgraphComputation_B_only_essential_output") )) {
            ...
            if(Settings.getBoolean("PTGLgraphComputation_B_AAgraph_allchainscombined")) {
                if(separateContactsByChain || cInfo == null) {
                    ...
                    String subDirTree = "";
                    if(Settings.getBoolean("PTGLgraphComputation_B_output_images_dir_tree") || Settings.getBoolean("PTGLgraphComputation_B_output_textfiles_dir_tree")) {
                    ...
                    if(Settings.getBoolean("PTGLgraphComputation_B_useDB")) {
                        try {
                            if(Settings.getBoolean("PTGLgraphComputation_B_write_graphstrings_to_database_aag")) {
                    ...
                    if(Settings.getBoolean("PTGLgraphComputation_B_compute_graph_metrics")) {    
                        //aag.selfCheck();
            ...
            if(separateContactsByChain || Settings.getBoolean("PTGLgraphComputation_B_AAgraph_perchain")) {
                String chainID;
                ...
                for(Chain c : handleChains) {
                    ...
                    if(Settings.getBoolean("PTGLgraphComputation_B_quit_after_aag")) {
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_output_textfiles_dir_tree_html")) {
            if(! silent) {
            ...
            if(Settings.getBoolean("PTGLgraphComputation_B_output_textfiles_dir_tree_core_html")) {  
                if(! silent) {
        ...
        */
        ...
        if(! silent) {
            ...
            if(Settings.getBoolean("PTGLgraphComputation_B_print_silent_notice")) {
                ...
                System.out.println(Settings.getApptag() + " [" + pdbid + "] [" + endTime + "] " + "All done silently, exiting. Total runtime was " + runtimeTotal_secs + " seconds ("+compTimes[0]+":" + String.format("%02d:%02d", compTimes[1], compTimes[2])+" hms). "+residues.size()+ "residues.");
            }
        }
        System.exit(0);
    }
    ...
    public static void drawPlccGraphFromFile(String plccGraphFile, String imgNoExt, Boolean drawFoldingGraphsAsWell) {
        ...
        //    calculateFoldingGraphsForSSEGraph(pg, Settings.get("PTGLgraphComputation_S_output_dir"));
        //}        
        //else {
    ...
    public static void calculateSSEGraphsForChains(List<Chain> allChains, ArrayList<MolContactInfo> resContacts, String pdbid, String outputDir) {
        ...
        for(Integer i = 0; i < allChains.size(); i++) {
            ...
            if(Settings.getBoolean("PTGLgraphComputation_B_ptgl_text_output")) {
                String sseMappingsFile = Settings.get("PTGLgraphComputation_S_output_dir") + fs + pdbid.toLowerCase()  + "_" + chain + ".ssemap";
            ...
            for(Integer j = 0; j < allChainSSEs.size(); j++) {
                ...
                if(Settings.getBoolean("PTGLgraphComputation_B_useDB")) {
                    ...
                    //if( ! Settings.getBoolean("PTGLgraphComputation_B_db_use_batch_inserts")) {
            ...
            /*
            if(Settings.getBoolean("PTGLgraphComputation_B_useDB") &&  Settings.getBoolean("PTGLgraphComputation_B_db_use_batch_inserts")) {
                try {
            ...
            */
            ...
            if(Settings.getBoolean("PTGLgraphComputation_B_graphtype_albe")) { graphTypes.add(SSEGraph.GRAPHTYPE_ALBE); }
            if(Settings.getBoolean("PTGLgraphComputation_B_graphtype_albelig")) { graphTypes.add(SSEGraph.GRAPHTYPE_ALBELIG); }
            if(Settings.getBoolean("PTGLgraphComputation_B_graphtype_alpha")) { graphTypes.add(SSEGraph.GRAPHTYPE_ALPHA); }
            if(Settings.getBoolean("PTGLgraphComputation_B_graphtype_alphalig")) { graphTypes.add(SSEGraph.GRAPHTYPE_ALPHALIG); }
            if(Settings.getBoolean("PTGLgraphComputation_B_graphtype_beta")) { graphTypes.add(SSEGraph.GRAPHTYPE_BETA); }
            if(Settings.getBoolean("PTGLgraphComputation_B_graphtype_betalig")) { graphTypes.add(SSEGraph.GRAPHTYPE_BETALIG); }
            ...
            for(String gt : graphTypes) {
                ...
                if(Settings.getBoolean("PTGLgraphComputation_B_debug_compareSSEContacts")) {
                    if(gt.equals(SSEGraph.GRAPHTYPE_ALBE)) {
                        if(! silent) {
                            System.out.println("Comparing calculated SSE contacts with those in the file '" + Settings.get("PTGLgraphComputation_S_debug_compareSSEContactsFile") + "'...");
                        }
                        FileParser.compareSSEContactsWithGeoDatFile(Settings.get("PTGLgraphComputation_S_debug_compareSSEContactsFile"), pg);
                    }        
                    else {
                        if(! silent) {
                ...
                String coilsUsed = "";
                if(Settings.getBoolean("PTGLgraphComputation_B_include_coils")) {
                ...
                fileNameWithExtension = fileNameWithoutExtension + Settings.get("PTGLgraphComputation_S_img_output_fileext");
                ...
                if(Settings.getBoolean("PTGLgraphComputation_B_output_GML")) {
                ...
                if(Settings.getBoolean("PTGLgraphComputation_B_output_TGF")) {
                ...
                if(Settings.getBoolean("PTGLgraphComputation_B_output_DOT")) {
                ...
                if(Settings.getBoolean("PTGLgraphComputation_B_output_kavosh")) {
                ...
                if(Settings.getBoolean("PTGLgraphComputation_B_output_eld")) {
                ...
                if(Settings.getBoolean("PTGLgraphComputation_B_output_plcc")) {
                ...
                if(Settings.getBoolean("PTGLgraphComputation_B_output_perlfg")) {
                ...
                if(Settings.getBoolean("PTGLgraphComputation_B_output_json")) {
                ...
                if(Settings.getBoolean("PTGLgraphComputation_B_output_msvg")) {
                ...
                if(Settings.getBoolean("PTGLgraphComputation_B_output_gexf")) {
                ...
                if(Settings.getBoolean("PTGLgraphComputation_B_output_xml")) {
                ...
                if(Settings.getBoolean("PTGLgraphComputation_B_output_cytoscapejs")) {
                ...
                */
                ...
                if(Settings.getBoolean("PTGLgraphComputation_B_useDB")) {
                    ...
                    try { 
                        Boolean res;
                        if(Settings.getBoolean("PTGLgraphComputation_B_write_graphstrings_to_database_pg")) {
                ...
                if(Settings.getBoolean("PTGLgraphComputation_B_Jmol_graph_vis_commands")) {                                                            
                ...
                if(Settings.getBoolean("PTGLgraphComputation_B_Jmol_graph_vis_resblue_commands")) {                                        
                ...
                if(Settings.getBoolean("PTGLgraphComputation_B_folding_graphs")) {
                    //if(gt.equals(ProtGraphs.GRAPHTYPE_STRING_ALPHA) || gt.equals(ProtGraphs.GRAPHTYPE_STRING_BETA) || gt.equals(ProtGraphs.GRAPHTYPE_STRING_ALBE)) {
                        ...
                        if (Settings.getBoolean("PTGLgraphComputation_B_matrix_structure_search") && Settings.get("PTGLgraphComputation_S_linear_notation_graph_type").equals(pg.getGraphType())){
                            ...
                            pattern = DBManager.parseRedOrAdjToMatrix(Settings.get("PTGLgraphComputation_S_linear_notation"), Settings.get("PTGLgraphComputation_S_linear_notation_graph_type"));
                            
                            if (pattern.size() <= matrix.size()){
                                //start searching
                                if (!silent){
                                    System.out.println("      --- Start searching the linear notation " + Settings.get("PTGLgraphComputation_S_linear_notation") +" in the folding graph. ---");
                                }
            ...
            if(Settings.getBoolean("PTGLgraphComputation_B_useDB") && Settings.getBoolean("PTGLgraphComputation_B_folding_graphs") && Settings.getBoolean("PTGLgraphComputation_B_compute_motifs")) {
    ...
    public static ProteinFoldingGraphResults calculateFoldingGraphsForSSEGraph(ProtGraph pg, String outputDir) {
        ...
        boolean silent = Settings.getBoolean("PTGLgraphComputation_B_silent");
        boolean essentialOutOnly = Settings.getBoolean("PTGLgraphComputation_B_only_essential_output");
        ...
        int fgMinSizeDraw = Settings.getInteger("PTGLgraphComputation_I_min_fgraph_size_draw");
        ...
        for(Integer j = 0; j < foldingGraphs.size(); j++) {            
            ...
            if(fg.numAlphaBetaVertices() >= Settings.getInteger("PTGLgraphComputation_I_min_fgraph_size_write_to_file")) {
                writeFGGraphStrings(fg, outputDir, fg.getFoldingGraphNumber());
                if(Settings.getBoolean("PTGLgraphComputation_B_output_fg_linear_notations_to_file")) {
            ...
            if(Settings.getBoolean("PTGLgraphComputation_B_foldgraphtype_KEY")) { notations.add(FoldingGraph.FG_NOTATION_KEY); }
            if(Settings.getBoolean("PTGLgraphComputation_B_foldgraphtype_ADJ")) { notations.add(FoldingGraph.FG_NOTATION_ADJ); }
            if(Settings.getBoolean("PTGLgraphComputation_B_foldgraphtype_RED")) { notations.add(FoldingGraph.FG_NOTATION_RED); }
            if(Settings.getBoolean("PTGLgraphComputation_B_foldgraphtype_SEQ")) { notations.add(FoldingGraph.FG_NOTATION_SEQ); }                                                                        
            if(Settings.getBoolean("PTGLgraphComputation_B_foldgraphtype_SEQ")) { notations.add(FoldingGraph.FG_NOTATION_DEF); }
            
            // We may need to write the folding graph to the database
            Long fgDbId = -1L;
            if(Settings.getBoolean("PTGLgraphComputation_B_useDB")) { 
                
                if(fg.numAlphaBetaVertices() < Settings.getInteger("PTGLgraphComputation_I_min_fgraph_size_write_to_db")) {
                    if(! (silent || essentialOutOnly)) {
                        System.out.println("       *Not writing " + gt + " folding graph #" + j + " of size " + fg.numVertices() + " to DB (minimum size is " + Settings.getInteger("PTGLgraphComputation_I_min_fgraph_size_write_to_db") + ").");
                    }                   
                }
                else {
                                
                    try { 
                        if(Settings.getBoolean("PTGLgraphComputation_B_write_graphstrings_to_database_fg")) {
            ...
            // draw folding graphs                                   
            if(Settings.getBoolean("PTGLgraphComputation_B_draw_folding_graphs")) {
                
                if(fg.numAlphaBetaVertices() >= Settings.getInteger("PTGLgraphComputation_I_min_fgraph_size_draw")) {
                    ...
                    for(String notation : notations) {                                                
                        ...
                        fgFile = outputDir + System.getProperty("file.separator") + fileNameWithoutExtension; //Settings.get("PTGLgraphComputation_S_img_output_fileext");
                    ...
                    // FG too small
                    if(! (silent  || essentialOutOnly)) {
                        System.out.println("        Not drawing any of the " + notations.size() + " notations of the " + pg.getGraphType() + " FG #" + j + " (fg_number=" + fg_number + "): albe size is " + fg.numAlphaBetaVertices() +", min is " + Settings.getInteger("PTGLgraphComputation_I_min_fgraph_size_draw") + ".");
                    }
                }
    ...
    */
    ...
    public static ProtGraph calcGraphType(String graphType, List<SSE> allChainSSEs, Chain c, List<MolContactInfo> resContacts, String pdbid) {
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_include_coils")) {
            keepSSEs.add(Settings.get("PTGLgraphComputation_S_coilSSECode"));
        }
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_ptgl_geodat_output")) {
            String gdf = Settings.get("PTGLgraphComputation_S_output_dir") + System.getProperty("file.separator") + pdbid + "_" + c.getPdbChainID() + "_" + graphType + ".geodat";            
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_useDB") && graphType.equals("albelig")) {
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_forceBackboneContacts")) {
            if(! silent) {
    ...
    public static ArrayList<MolContactInfo> calculateAllContacts(ArrayList<Molecule> mols) {
        ...
        Integer atomRadiusLig = Settings.getInteger("PTGLgraphComputation_I_lig_atom_radius");
    ...
    public static ArrayList<MolContactInfo> calculateAllContactsLimitedByChain(List<Molecule> mols, String handledChain) {
        ...
        Boolean includeLigandsFromOtherChains = Settings.getBoolean("PTGLgraphComputation_B_consider_all_ligands_for_each_chain");
        /*
    ...
    public static MolContactInfo atomContactsStatistics(Atom atomOfResA, Atom atomOfResB, MolContactInfo currentMci, Integer indexOfAtomInResA, Integer indexOfAtomInResB, Integer[] contactAtomNumInResidueA, Integer[] contactAtomNumInResidueB, Integer aIntID, Integer bIntID){
        ...
        if(atomOfResA.isProteinAtom() && atomOfResB.isProteinAtom()) {
            ...
            if(indexOfAtomInResA <= numOfLastBackboneAtomInResidue) {
                ...
                currentMci.increaseContact(MolContactInfo.CL,1);
            ...
            if(indexOfAtomInResB <= numOfLastBackboneAtomInResidue) {
                ...
                currentMci.increaseContact(MolContactInfo.LC,1);
            ...
            currentMci.increaseContact(MolContactInfo.LL,1);
            ...
            currentMci.increaseContact(MolContactInfo.RX,1);
            ...
            currentMci.increaseContact(MolContactInfo.XR,1);
            ...
            currentMci.increaseContact(MolContactInfo.RR,1);
    ...
    /**
     * Calculates the atom contacts between the residues 'a' and 'b' if both are AAs.
    ...
    public static MolContactInfo calculateAtomContactsBetweenResidues(Molecule a, Molecule b) {
        ...
        */
        ...
        if (result.getNumContactsTotal() == 0){
            result = null;
        }
...
//                        System.out.println("New IVDW: " + x.toString() + "/" + y.toString());
                    ...
                    else if(Settings.getBoolean("PTGLgraphComputation_B_alternate_aminoacid_contact_model_with_ligands")) {
...
//                        System.out.println("New LigLig: " + x.toString() + "/" + y.toString());
    ...
    public static Boolean writeDsspLigFile(String sseFile, String dsspLigFile, ArrayList<MolContactInfo> contacts, ArrayList<Residue> res) {
        ...
        for(Integer i = 0; i < res.size(); i++) {
            ...
            if(r.isLigand()) {
                ...
                //      '   47   47 A E  E'
                dsspLigFH.printf(loc, "  %3d  %3d %1s %1s  %1s", r.getDsspNum(), r.getPdbNum(), r.getChainID(), r.getAAName1(), Settings.get("PTGLgraphComputation_S_ligSSECode"));
                ...
                dsspLigFH.printf(loc, " %7s %3d %3d%1s %3d", "       ", 0, 0, " ", Settings.getInteger("PTGLgraphComputation_I_ligSAS"));
 ...
 last residue of the chainName it is associated with. This is required for PTGL compatibility (don't ask).
     ...
     while ((thisLine = in.readLine()) != null) {
       ...
       if(i == lineno) {
           // Now write the line for this ligand in DSSP format (see http://swift.cmbi.ru.nl/gv/dssp/).
            ...
            //  bet sheet label (empty (" ") for ligands) and solvent accessible surface (SAS) of this residue (not required by PTGL, just set to some value)
            //      '   47   47 A E  E    S-c   29   0A  71'
            out.printf(loc, " %7s %3d %3d%1s %3d", "       ", 0, 0, " ", Settings.getInteger("PTGLgraphComputation_I_ligSAS"));
    ...
    private static ArrayList<SSE> createAllDsspSSEsFromResidueList(ArrayList<Residue> resList) {
        ...
        String coil = Settings.get("PTGLgraphComputation_S_coilSSECode");
        ...
        for(Integer i = 0; i < resList.size(); i++) {
            ...
            if (i != 0 && i !=  resList.size() - 1){ //we are not in the first and not in the last iteration
                findE_E = Settings.getBoolean("PTGLgraphComputation_B_fill_gaps");
            ...
            if (Settings.getBoolean("PTGLgraphComputation_B_change_dssp_sse_b_to_e") && curResString.equals("B")){
                curResString = "E";
    ...
    private static List<SSE> createAllLigandSSEsFromResidueList(List<Ligand> resList, List<SSE> dsspSSElist) {
        ...
        Integer ligMinAtoms = Settings.getInteger("PTGLgraphComputation_I_lig_min_atoms");
        Integer ligMaxAtoms = Settings.getInteger("PTGLgraphComputation_I_lig_max_atoms");
        Boolean noMax = false;
        if(ligMinAtoms <= 0) {
    ...
    private static ArrayList<SSE> createAllPtglSSEsFromDsspSSEList(List<SSE> inputSSEs) {
        ...
        List<SSE> consideredSSEs = removeShortSSEs(impSSEs, Settings.getInteger("PTGLgraphComputation_I_min_SSE_length"));
            ...
            if(cst.equals("L")) {
                ...
                if(numSSEsLeft < 1) {
                    ...
                    if(nextSSE.getSseType().equals("H") || nextSSE.getSseType().equals("I") || nextSSE.getSseType().equals("G")) {
                        ...
                        if(Settings.getBoolean("PTGLgraphComputation_B_merge_helices")) {
                            ...
                            if(curSSE.getPrimarySeqDistanceInAminoAcidsTo(nextSSE) <= Settings.getInteger("PTGLgraphComputation_I_merge_helices_max_dist")) {
    ...
    public static void calculateComplexGraph(List<Chain> allChains, List<MolContactInfo> resContacts, String pdbid, String outputDir, String graphType) {
        ...
        ComplexGraph compGraph = new ComplexGraph(pdbid, allChains, resContacts, Settings.getBoolean("PTGLgraphComputation_B_writeComplexContactCSV"));    
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_writeComplexContactCSV")) {
            try {
        ...
        fileNameSSELevelWithExtension = fileNameSSELevelWithoutExtension + Settings.get("PTGLgraphComputation_S_img_output_fileext");
        fileNameChainLevelWithExtension = fileNameChainLevelWithoutExtension + Settings.get("PTGLgraphComputation_S_img_output_fileext");
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_output_compgraph_GML")) {
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_output_compgraph_TGF")) {
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_output_compgraph_DOT")) {
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_output_compgraph_kavosh")) {
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_output_compgraph_XML")) {
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_output_compgraph_JSON")) {
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_output_compgraph_eld")) {
        ...
        // write the SSE info text file for the image (plcc graph format file)
        if(Settings.getBoolean("PTGLgraphComputation_B_output_compgraph_plcc")) {
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_useDB")) {
            ...
            //dbImagePath += DrawTools.getFileExtensionForImageFormat(format);
            try {
                if(Settings.getBoolean("PTGLgraphComputation_B_write_graphstrings_to_database_cg")) {
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_compute_graph_metrics") && graphType.equals(SSEGraph.GRAPHTYPE_ALBELIG)) {
        ...
        if(Settings.getBoolean("PTGLgraphComputation_B_draw_graphs") && Settings.getBoolean("PTGLgraphComputation_B_draw_ligandcomplexgraphs") && graphType.equals(SSEGraph.GRAPHTYPE_ALBELIG)) {
            if(! silent) {
