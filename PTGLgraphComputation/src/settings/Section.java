    ...
    private void initSettings() {
        ...
        switch(name) {
            ...
            case "Assembly prediction (AP)":
                settings.add(new Setting("PTGLgraphComputation_B_type_assembly_prediction", 'I', "0", "Whether to choose edges greedily (0), interactively (1), or random weighted choice (2)."));
            ...
            case "Contact definition":
                ...
                settings.add(new Setting("PTGLgraphComputation_CTL", 'B', "false", "Whether contacts transitive by ligands should be considered for the contact calculation, and subsequently in the complex graphs."));
