...
# Load the structure
load 7zdh.cif, complex

# First color everything white
color white, all
# Select and color the found clusters
select cluster0, chain A+H+J+K+Y+l+m+q+z
select cluster1, chain 3+4+5+6+9+b+c+d+e+f+g+h+i+j
select cluster2, chain L+M+V+W+X+Z+n+p+r+s+t+u+v+w+y
select cluster3, chain N+k+o+x
select cluster4, chain 1+2+a

set_color newColor0, [0.0, 1.0, 0.0] 
color newColor0, cluster0
set_color newColor1, [1.0, 1.0, 0.0] 
color newColor1, cluster1
set_color newColor2, [0.0, 0.0, 1.0] 
color newColor2, cluster2
set_color newColor3, [0.2, 0.6, 0.2] 
color newColor3, cluster3
set_color newColor4, [1.0, 0.0, 0.0] 
...
pseudoatom ps_A-H, psA or psH, label=105
pseudoatom ps_A-6, psA or ps6, label=17
pseudoatom ps_A-J, psA or psJ, label=51
pseudoatom ps_A-q, psA or psq, label=2
pseudoatom ps_A-K, psA or psK, label=8
pseudoatom ps_A-N, psA or psN, label=1
pseudoatom ps_A-d, psA or psd, label=7
pseudoatom ps_A-g, psA or psg, label=5
pseudoatom ps_A-m, psA or psm, label=7
pseudoatom ps_A-4, psA or ps4, label=23
pseudoatom ps_H-A, psH or psA, label=105
pseudoatom ps_H-6, psH or ps6, label=57
pseudoatom ps_H-J, psH or psJ, label=30
pseudoatom ps_H-q, psH or psq, label=37
pseudoatom ps_H-9, psH or ps9, label=24
pseudoatom ps_H-d, psH or psd, label=3
pseudoatom ps_H-Y, psH or psY, label=5
pseudoatom ps_H-h, psH or psh, label=2
pseudoatom ps_H-z, psH or psz, label=45
pseudoatom ps_H-i, psH or psi, label=3
pseudoatom ps_H-m, psH or psm, label=26
pseudoatom ps_H-4, psH or ps4, label=40
pseudoatom ps_J-A, psJ or psA, label=51
pseudoatom ps_J-H, psJ or psH, label=30
pseudoatom ps_J-q, psJ or psq, label=25
pseudoatom ps_J-K, psJ or psK, label=96
pseudoatom ps_J-L, psJ or psL, label=1
pseudoatom ps_J-N, psJ or psN, label=23
pseudoatom ps_J-d, psJ or psd, label=4
pseudoatom ps_J-z, psJ or psz, label=8
pseudoatom ps_J-k, psJ or psk, label=2
pseudoatom ps_J-l, psJ or psl, label=16
pseudoatom ps_J-m, psJ or psm, label=1
pseudoatom ps_K-A, psK or psA, label=8
pseudoatom ps_K-J, psK or psJ, label=96
pseudoatom ps_K-L, psK or psL, label=12
pseudoatom ps_K-N, psK or psN, label=49
pseudoatom ps_K-l, psK or psl, label=19
pseudoatom ps_K-4, psK or ps4, label=7
pseudoatom ps_L-J, psL or psJ, label=1
pseudoatom ps_L-K, psL or psK, label=12
pseudoatom ps_L-M, psL or psM, label=69
pseudoatom ps_L-N, psL or psN, label=35
pseudoatom ps_L-V, psL or psV, label=19
pseudoatom ps_L-W, psL or psW, label=4
pseudoatom ps_L-X, psL or psX, label=7
pseudoatom ps_L-Z, psL or psZ, label=32
pseudoatom ps_L-n, psL or psn, label=28
pseudoatom ps_L-p, psL or psp, label=25
pseudoatom ps_L-r, psL or psr, label=31
pseudoatom ps_L-s, psL or pss, label=25
pseudoatom ps_L-t, psL or pst, label=42
pseudoatom ps_L-u, psL or psu, label=51
pseudoatom ps_L-v, psL or psv, label=57
pseudoatom ps_L-w, psL or psw, label=1
pseudoatom ps_L-4, psL or ps4, label=5
pseudoatom ps_M-L, psM or psL, label=69
pseudoatom ps_M-N, psM or psN, label=38
pseudoatom ps_M-V, psM or psV, label=7
pseudoatom ps_M-W, psM or psW, label=43
pseudoatom ps_M-Y, psM or psY, label=5
pseudoatom ps_M-Z, psM or psZ, label=23
pseudoatom ps_M-k, psM or psk, label=2
pseudoatom ps_M-o, psM or pso, label=3
pseudoatom ps_M-p, psM or psp, label=43
pseudoatom ps_M-t, psM or pst, label=10
pseudoatom ps_M-v, psM or psv, label=10
pseudoatom ps_M-w, psM or psw, label=52
pseudoatom ps_M-y, psM or psy, label=20
pseudoatom ps_M-4, psM or ps4, label=11
pseudoatom ps_N-A, psN or psA, label=1
pseudoatom ps_N-J, psN or psJ, label=23
pseudoatom ps_N-K, psN or psK, label=49
pseudoatom ps_N-L, psN or psL, label=35
pseudoatom ps_N-M, psN or psM, label=38
pseudoatom ps_N-V, psN or psV, label=16
pseudoatom ps_N-W, psN or psW, label=6
pseudoatom ps_N-Y, psN or psY, label=8
pseudoatom ps_N-k, psN or psk, label=59
pseudoatom ps_N-l, psN or psl, label=32
pseudoatom ps_N-o, psN or pso, label=34
pseudoatom ps_N-w, psN or psw, label=1
pseudoatom ps_N-4, psN or ps4, label=30
pseudoatom ps_V-L, psV or psL, label=19
pseudoatom ps_V-M, psV or psM, label=7
pseudoatom ps_V-N, psV or psN, label=16
pseudoatom ps_V-W, psV or psW, label=6
pseudoatom ps_W-L, psW or psL, label=4
pseudoatom ps_W-M, psW or psM, label=43
pseudoatom ps_W-N, psW or psN, label=6
pseudoatom ps_W-V, psW or psV, label=6
pseudoatom ps_W-X, psW or psX, label=1
pseudoatom ps_W-Y, psW or psY, label=21
pseudoatom ps_W-Z, psW or psZ, label=43
pseudoatom ps_W-l, psW or psl, label=38
pseudoatom ps_W-m, psW or psm, label=1
pseudoatom ps_W-o, psW or pso, label=23
pseudoatom ps_W-q, psW or psq, label=2
pseudoatom ps_W-r, psW or psr, label=9
pseudoatom ps_W-t, psW or pst, label=19
pseudoatom ps_W-w, psW or psw, label=31
pseudoatom ps_W-y, psW or psy, label=22
pseudoatom ps_X-L, psX or psL, label=7
pseudoatom ps_X-W, psX or psW, label=1
pseudoatom ps_X-r, psX or psr, label=16
pseudoatom ps_X-t, psX or pst, label=26
pseudoatom ps_X-u, psX or psu, label=5
pseudoatom ps_X-v, psX or psv, label=2
pseudoatom ps_X-n, psX or psn, label=23
pseudoatom ps_Y-H, psY or psH, label=5
pseudoatom ps_Y-M, psY or psM, label=5
pseudoatom ps_Y-N, psY or psN, label=8
pseudoatom ps_Y-W, psY or psW, label=21
pseudoatom ps_Y-o, psY or pso, label=21
pseudoatom ps_Y-q, psY or psq, label=67
pseudoatom ps_Y-x, psY or psx, label=1
pseudoatom ps_Y-z, psY or psz, label=39
pseudoatom ps_Y-l, psY or psl, label=19
pseudoatom ps_Y-m, psY or psm, label=41
pseudoatom ps_Z-L, psZ or psL, label=32
pseudoatom ps_Z-M, psZ or psM, label=23
pseudoatom ps_Z-W, psZ or psW, label=43
pseudoatom ps_Z-o, psZ or pso, label=30
pseudoatom ps_Z-p, psZ or psp, label=14
pseudoatom ps_Z-r, psZ or psr, label=52
pseudoatom ps_Z-s, psZ or pss, label=16
pseudoatom ps_Z-v, psZ or psv, label=2
pseudoatom ps_Z-w, psZ or psw, label=54
pseudoatom ps_Z-y, psZ or psy, label=12
pseudoatom ps_k-J, psk or psJ, label=2
pseudoatom ps_k-M, psk or psM, label=2
pseudoatom ps_k-N, psk or psN, label=59
pseudoatom ps_k-o, psk or pso, label=16
pseudoatom ps_k-w, psk or psw, label=19
pseudoatom ps_k-f, psk or psf, label=7
pseudoatom ps_k-x, psk or psx, label=22
pseudoatom ps_k-4, psk or ps4, label=13
pseudoatom ps_l-J, psl or psJ, label=16
pseudoatom ps_l-K, psl or psK, label=19
pseudoatom ps_l-N, psl or psN, label=32
pseudoatom ps_l-W, psl or psW, label=38
pseudoatom ps_l-Y, psl or psY, label=19
pseudoatom ps_l-o, psl or pso, label=4
pseudoatom ps_l-q, psl or psq, label=50
pseudoatom ps_l-z, psl or psz, label=3
pseudoatom ps_l-m, psl or psm, label=2
pseudoatom ps_m-A, psm or psA, label=7
pseudoatom ps_m-H, psm or psH, label=26
pseudoatom ps_m-J, psm or psJ, label=1
pseudoatom ps_m-W, psm or psW, label=1
pseudoatom ps_m-Y, psm or psY, label=41
pseudoatom ps_m-l, psm or psl, label=2
pseudoatom ps_m-q, psm or psq, label=18
pseudoatom ps_m-9, psm or ps9, label=7
pseudoatom ps_n-L, psn or psL, label=28
pseudoatom ps_n-X, psn or psX, label=23
pseudoatom ps_n-t, psn or pst, label=17
pseudoatom ps_n-u, psn or psu, label=33
pseudoatom ps_o-M, pso or psM, label=3
pseudoatom ps_o-N, pso or psN, label=34
pseudoatom ps_o-W, pso or psW, label=23
pseudoatom ps_o-Y, pso or psY, label=21
pseudoatom ps_o-Z, pso or psZ, label=30
pseudoatom ps_o-k, pso or psk, label=16
pseudoatom ps_o-l, pso or psl, label=4
pseudoatom ps_o-p, pso or psp, label=4
pseudoatom ps_o-w, pso or psw, label=4
pseudoatom ps_o-x, pso or psx, label=29
pseudoatom ps_p-L, psp or psL, label=25
pseudoatom ps_p-M, psp or psM, label=43
pseudoatom ps_p-Z, psp or psZ, label=14
pseudoatom ps_p-o, psp or pso, label=4
pseudoatom ps_p-t, psp or pst, label=53
pseudoatom ps_p-v, psp or psv, label=60
pseudoatom ps_q-A, psq or psA, label=2
pseudoatom ps_q-H, psq or psH, label=37
pseudoatom ps_q-J, psq or psJ, label=25
pseudoatom ps_q-W, psq or psW, label=2
pseudoatom ps_q-Y, psq or psY, label=67
pseudoatom ps_q-l, psq or psl, label=50
pseudoatom ps_q-m, psq or psm, label=18
pseudoatom ps_q-9, psq or ps9, label=8
pseudoatom ps_q-h, psq or psh, label=15
pseudoatom ps_q-z, psq or psz, label=21
pseudoatom ps_q-4, psq or ps4, label=43
pseudoatom ps_r-L, psr or psL, label=31
pseudoatom ps_r-W, psr or psW, label=9
pseudoatom ps_r-X, psr or psX, label=16
pseudoatom ps_r-Z, psr or psZ, label=52
pseudoatom ps_r-s, psr or pss, label=26
pseudoatom ps_r-t, psr or pst, label=40
pseudoatom ps_s-L, pss or psL, label=25
pseudoatom ps_s-Z, pss or psZ, label=16
pseudoatom ps_s-r, pss or psr, label=26
pseudoatom ps_s-u, pss or psu, label=29
pseudoatom ps_s-v, pss or psv, label=51
pseudoatom ps_t-L, pst or psL, label=42
pseudoatom ps_t-M, pst or psM, label=10
pseudoatom ps_t-W, pst or psW, label=19
pseudoatom ps_t-X, pst or psX, label=26
pseudoatom ps_t-n, pst or psn, label=17
pseudoatom ps_t-p, pst or psp, label=53
pseudoatom ps_t-r, pst or psr, label=40
pseudoatom ps_t-v, pst or psv, label=8
pseudoatom ps_t-w, pst or psw, label=3
pseudoatom ps_u-L, psu or psL, label=51
pseudoatom ps_u-X, psu or psX, label=5
pseudoatom ps_u-n, psu or psn, label=33
pseudoatom ps_u-s, psu or pss, label=29
pseudoatom ps_v-L, psv or psL, label=57
pseudoatom ps_v-M, psv or psM, label=10
pseudoatom ps_v-X, psv or psX, label=2
pseudoatom ps_v-Z, psv or psZ, label=2
pseudoatom ps_v-p, psv or psp, label=60
pseudoatom ps_v-s, psv or pss, label=51
pseudoatom ps_v-t, psv or pst, label=8
pseudoatom ps_w-L, psw or psL, label=1
pseudoatom ps_w-M, psw or psM, label=52
pseudoatom ps_w-N, psw or psN, label=1
pseudoatom ps_w-W, psw or psW, label=31
pseudoatom ps_w-Z, psw or psZ, label=54
pseudoatom ps_w-k, psw or psk, label=19
pseudoatom ps_w-o, psw or pso, label=4
pseudoatom ps_w-t, psw or pst, label=3
pseudoatom ps_w-4, psw or ps4, label=8
pseudoatom ps_x-Y, psx or psY, label=1
pseudoatom ps_x-k, psx or psk, label=22
pseudoatom ps_x-o, psx or pso, label=29
pseudoatom ps_y-M, psy or psM, label=20
pseudoatom ps_y-W, psy or psW, label=22
pseudoatom ps_y-Z, psy or psZ, label=12
pseudoatom ps_z-H, psz or psH, label=45
pseudoatom ps_z-J, psz or psJ, label=8
pseudoatom ps_z-Y, psz or psY, label=39
pseudoatom ps_z-l, psz or psl, label=3
pseudoatom ps_z-q, psz or psq, label=21
pseudoatom ps_z-9, psz or ps9, label=3
pseudoatom ps_1-a, ps1 or psa, label=52
pseudoatom ps_1-c, ps1 or psc, label=18
pseudoatom ps_1-h, ps1 or psh, label=4
pseudoatom ps_1-2, ps1 or ps2, label=125
pseudoatom ps_1-3, ps1 or ps3, label=54
pseudoatom ps_2-1, ps2 or ps1, label=125
pseudoatom ps_2-a, ps2 or psa, label=34
pseudoatom ps_2-b, ps2 or psb, label=2
pseudoatom ps_2-c, ps2 or psc, label=4
pseudoatom ps_2-3, ps2 or ps3, label=27
pseudoatom ps_3-1, ps3 or ps1, label=54
pseudoatom ps_3-2, ps3 or ps2, label=27
pseudoatom ps_3-5, ps3 or ps5, label=22
pseudoatom ps_3-9, ps3 or ps9, label=20
pseudoatom ps_3-a, ps3 or psa, label=6
pseudoatom ps_3-b, ps3 or psb, label=16
pseudoatom ps_3-c, ps3 or psc, label=54
pseudoatom ps_3-d, ps3 or psd, label=4
pseudoatom ps_3-e, ps3 or pse, label=51
pseudoatom ps_3-g, ps3 or psg, label=21
pseudoatom ps_3-h, ps3 or psh, label=13
pseudoatom ps_3-i, ps3 or psi, label=19
pseudoatom ps_3-4, ps3 or ps4, label=33
pseudoatom ps_4-A, ps4 or psA, label=23
pseudoatom ps_4-H, ps4 or psH, label=40
pseudoatom ps_4-K, ps4 or psK, label=7
pseudoatom ps_4-L, ps4 or psL, label=5
pseudoatom ps_4-M, ps4 or psM, label=11
pseudoatom ps_4-N, ps4 or psN, label=30
pseudoatom ps_4-k, ps4 or psk, label=13
pseudoatom ps_4-q, ps4 or psq, label=43
pseudoatom ps_4-w, ps4 or psw, label=8
pseudoatom ps_4-3, ps4 or ps3, label=33
pseudoatom ps_4-5, ps4 or ps5, label=94
pseudoatom ps_4-6, ps4 or ps6, label=61
pseudoatom ps_4-9, ps4 or ps9, label=78
pseudoatom ps_4-b, ps4 or psb, label=5
pseudoatom ps_4-c, ps4 or psc, label=1
pseudoatom ps_4-f, ps4 or psf, label=19
pseudoatom ps_4-g, ps4 or psg, label=4
pseudoatom ps_4-h, ps4 or psh, label=39
pseudoatom ps_5-3, ps5 or ps3, label=22
pseudoatom ps_5-4, ps5 or ps4, label=94
pseudoatom ps_5-6, ps5 or ps6, label=20
pseudoatom ps_5-9, ps5 or ps9, label=8
pseudoatom ps_5-c, ps5 or psc, label=40
pseudoatom ps_5-d, ps5 or psd, label=18
pseudoatom ps_5-f, ps5 or psf, label=57
pseudoatom ps_5-g, ps5 or psg, label=33
pseudoatom ps_5-h, ps5 or psh, label=50
pseudoatom ps_6-A, ps6 or psA, label=17
pseudoatom ps_6-H, ps6 or psH, label=57
pseudoatom ps_6-4, ps6 or ps4, label=61
pseudoatom ps_6-5, ps6 or ps5, label=20
pseudoatom ps_6-9, ps6 or ps9, label=50
pseudoatom ps_6-d, ps6 or psd, label=21
pseudoatom ps_6-h, ps6 or psh, label=1
pseudoatom ps_6-i, ps6 or psi, label=6
pseudoatom ps_9-H, ps9 or psH, label=24
pseudoatom ps_9-m, ps9 or psm, label=7
pseudoatom ps_9-q, ps9 or psq, label=8
pseudoatom ps_9-z, ps9 or psz, label=3
pseudoatom ps_9-3, ps9 or ps3, label=20
pseudoatom ps_9-4, ps9 or ps4, label=78
pseudoatom ps_9-5, ps9 or ps5, label=8
pseudoatom ps_9-6, ps9 or ps6, label=50
pseudoatom ps_9-b, ps9 or psb, label=39
pseudoatom ps_9-c, ps9 or psc, label=6
pseudoatom ps_9-d, ps9 or psd, label=2
pseudoatom ps_9-h, ps9 or psh, label=37
pseudoatom ps_9-i, ps9 or psi, label=77
pseudoatom ps_a-1, psa or ps1, label=52
pseudoatom ps_a-2, psa or ps2, label=34
pseudoatom ps_a-3, psa or ps3, label=6
pseudoatom ps_a-c, psa or psc, label=8
pseudoatom ps_b-2, psb or ps2, label=2
pseudoatom ps_b-3, psb or ps3, label=16
pseudoatom ps_b-4, psb or ps4, label=5
pseudoatom ps_b-9, psb or ps9, label=39
pseudoatom ps_b-c, psb or psc, label=4
pseudoatom ps_b-d, psb or psd, label=15
pseudoatom ps_b-i, psb or psi, label=24
pseudoatom ps_c-1, psc or ps1, label=18
pseudoatom ps_c-2, psc or ps2, label=4
pseudoatom ps_c-3, psc or ps3, label=54
pseudoatom ps_c-4, psc or ps4, label=1
pseudoatom ps_c-5, psc or ps5, label=40
pseudoatom ps_c-9, psc or ps9, label=6
pseudoatom ps_c-a, psc or psa, label=8
pseudoatom ps_c-b, psc or psb, label=4
pseudoatom ps_c-d, psc or psd, label=11
pseudoatom ps_c-f, psc or psf, label=2
pseudoatom ps_c-g, psc or psg, label=26
pseudoatom ps_c-i, psc or psi, label=3
pseudoatom ps_d-A, psd or psA, label=7
pseudoatom ps_d-H, psd or psH, label=3
pseudoatom ps_d-J, psd or psJ, label=4
pseudoatom ps_d-3, psd or ps3, label=4
pseudoatom ps_d-5, psd or ps5, label=18
pseudoatom ps_d-6, psd or ps6, label=21
pseudoatom ps_d-9, psd or ps9, label=2
pseudoatom ps_d-b, psd or psb, label=15
pseudoatom ps_d-c, psd or psc, label=11
pseudoatom ps_d-g, psd or psg, label=10
pseudoatom ps_d-i, psd or psi, label=2
pseudoatom ps_e-3, pse or ps3, label=51
pseudoatom ps_f-k, psf or psk, label=7
pseudoatom ps_f-4, psf or ps4, label=19
pseudoatom ps_f-5, psf or ps5, label=57
pseudoatom ps_f-c, psf or psc, label=2
pseudoatom ps_f-h, psf or psh, label=7
pseudoatom ps_g-A, psg or psA, label=5
pseudoatom ps_g-3, psg or ps3, label=21
pseudoatom ps_g-4, psg or ps4, label=4
pseudoatom ps_g-5, psg or ps5, label=33
pseudoatom ps_g-c, psg or psc, label=26
pseudoatom ps_g-d, psg or psd, label=10
pseudoatom ps_g-j, psg or psj, label=21
pseudoatom ps_h-H, psh or psH, label=2
pseudoatom ps_h-q, psh or psq, label=15
pseudoatom ps_h-1, psh or ps1, label=4
pseudoatom ps_h-3, psh or ps3, label=13
pseudoatom ps_h-4, psh or ps4, label=39
pseudoatom ps_h-5, psh or ps5, label=50
pseudoatom ps_h-6, psh or ps6, label=1
pseudoatom ps_h-9, psh or ps9, label=37
pseudoatom ps_h-f, psh or psf, label=7
pseudoatom ps_h-i, psh or psi, label=14
pseudoatom ps_i-H, psi or psH, label=3
pseudoatom ps_i-3, psi or ps3, label=19
pseudoatom ps_i-6, psi or ps6, label=6
pseudoatom ps_i-9, psi or ps9, label=77
pseudoatom ps_i-b, psi or psb, label=24
pseudoatom ps_i-c, psi or psc, label=3
pseudoatom ps_i-d, psi or psd, label=2
pseudoatom ps_i-h, psi or psh, label=14
pseudoatom ps_j-g, psj or psg, label=21
